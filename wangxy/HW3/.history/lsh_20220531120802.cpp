...
int main()
{
    ...
    tmp_SignatureMatrix[0] = {1,3,2,0,2,2,1,4,2,1,2},
    tmp_SignatureMatrix[0] = {3,0,3,0,4,3,2,0,0,4,2},
    tmp_SignatureMatrix[0] = {0,4,3,1,5,3,3,2,3,5,4},
    tmp_SignatureMatrix[0] = {2,1,1,0,4,1,2,1,4,2,5},
    tmp_SignatureMatrix[0] = {4,2,1,0,5,2,3,2,3,5,4},
    tmp_SignatureMatrix[0] = {2,4,3,0,5,3,3,4,4,5,3},
    tmp_SignatureMatrix[0] = {0,2,4,1,3,4,3,2,2,2,4},
    tmp_SignatureMatrix[0] = {0,2,1,0,5,1,1,1,1,5,1},
    tmp_SignatureMatrix[0] = {0,5,1,0,2,1,3,2,1,5,4},
