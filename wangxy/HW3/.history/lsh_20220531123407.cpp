...
int ** compat(int SignatureMatrix[][DOCS_NUM], int r){
    int **tmp_SignatureMatrix = new int *[int(SIGNATURES_NUM / r)][DOCS_NUM] = {0};
    ...
    return (int **)tmp_SignatureMatrix;
}
...
int main()
{
    ...
    std::cout<<int(SIGNATURES_NUM / 3)<<std::endl;
    std::cout<<compat_matrix<<std::endl;
